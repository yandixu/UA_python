...
def rebuild(p,color_list):
    for r in range(1,len(color_list)-1):
        for c in range(1,len(color_list[r])-1):
            if color_list[r][c] == "green":
                neighbour = [color_list[r][c-1],color_list[r][c+1],color_list[r-1][c],color_list[r+1][c]]
                ...
                if "red" in neighbour:
                    ...
                    if percent <= 75:
                        ...
                        color_list[r][c] = "green"
                        
            elif color_list[r][c] == "red":
                color_list[r][c] = "green"
